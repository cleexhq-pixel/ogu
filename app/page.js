...
const COPY = {
  en: {
    ...
    hero_title_1: "That 90 seconds,",
    hero_title_2: "Make it count",
    hero_sub: "A fansign video call is just 90 seconds.\nPractice what you want to say\nand make it a moment you won't regret.",
    ...
    cta_bottom: "Start Practicing Now",
  ...
  ko: {
    ...
    hero_title_1: "그 90초,",
    hero_title_2: "제대로 써보세요",
    hero_sub: "팬싸인회 영상통화는 단 90초.\n하고 싶은 말을 미리 연습하고\n후회 없는 순간을 만들어요.",
    cta: "지금 연습 시작하기",
  ...
  id: {
    ...
    hero_title_2: "Manfaatkan sebaik-baiknya",
    hero_sub: "Video call fansign hanya 90 detik.\nLatih apa yang ingin kamu ucapkan\ndan buat momen yang tak terlupakan.",
    cta: "Mulai Latihan Sekarang",
    ...
    cta_bottom: "Mulai Latihan Sekarang",
  ...
  pt: {
    ...
    hero_title_2: "Use-os bem",
    hero_sub: "A videochamada do fansign dura apenas 90 segundos.\nPratique o que quer dizer\ne crie um momento inesquecível.",
    cta: "Começar a Praticar Agora",
    ...
    cta_bottom: "Começar a Praticar Agora",
  ...
  fr: {
    ...
    hero_title_2: "Faites-en quelque chose",
    hero_sub: "L'appel vidéo fansign dure seulement 90 secondes.\nPratiquez ce que vous voulez dire\net vivez un moment inoubliable.",
    ...
    cta_bottom: "Commencer à pratiquer",
