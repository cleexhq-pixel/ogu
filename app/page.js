  ...
  return (
    <main className="flex min-h-screen flex-col items-center px-6 py-10">
      <div className="w-full max-w-3xl space-y-8 relative">
        <div className="absolute right-0 -top-4 flex items-center gap-1 rounded-full bg-[#241208]/90 border border-[#3A2515] px-1.5 py-1 text-[11px] shadow-[0_12px_30px_rgba(0,0,0,0.6)]">
          <button
            type="button"
        ...
        <header className="text-center space-y-3 pt-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-[#FFD93D] drop-shadow-[0_0_25px_rgba(255,217,61,0.35)]">
            🐥 오구오구
          </h1>
        ...
        <section className="grid gap-6 md:grid-cols-[1.2fr,1fr] items-start">
          <div className="space-y-5">
            <div className="rounded-3xl border border-[#3A2515] bg-[#241208]/90 p-4 sm:p-5 shadow-[0_18px_50px_rgba(0,0,0,0.5)]">
                ...
                {LEVELS.map((level) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex flex-col items-start rounded-2xl border px-4 py-3 text-left transition-all duration-150 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFD93D] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1A1008] ${
                        isActive
                    ...
                    >
                      ...
                      <span className="text-xs font-semibold text-[#FFE9A6]">
                        {level.title}
                      </span>
                      <span className="mt-0.5 text-[11px] text-[#D9BFA3]">
                        {language === "ko"
                          ? level.subtitleKo
                          : level.subtitleEn}
                      </span>
                ...
                {PERSONAS.map((persona) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex flex-col items-start rounded-2xl border px-4 py-3 text-left transition-all duration-150 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6B4A] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1A1008] ${
                        isActive
                    ...
                    >
                      ...
                      <span className="mb-1 text-xl">{persona.emoji}</span>
                      <span className="text-xs font-semibold text-[#FFE9A6]">
                        {persona.title}
                      </span>
                      <span className="mt-0.5 text-[11px] text-[#D9BFA3]">
          ...
          <aside className="space-y-4 rounded-3xl border border-[#3A2515] bg-[#241208]/95 p-4 sm:p-5 shadow-[0_18px_50px_rgba(0,0,0,0.6)]">
            <h2 className="text-sm font-semibold text-[#FFE9A6]">
            ...
            <button
              ...
              onClick={handleStart}
              disabled={!canStart}
              className={`flex w-full items-center justify-center gap-1.5 rounded-full px-5 py-3 text-sm font-semibold text-white transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FFD93D] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1A1008] ${
                canStart
