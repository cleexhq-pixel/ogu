...
const COPY = {
  en: {
    ...
    why: [
      { title: "I just cried the whole time", desc: "" },
      { title: "I couldn't say a word", desc: "" },
      { title: "A regret I can't undo", desc: "" },
    ],
    cta_bottom: "Start Your 90 Seconds",
  ...
  ko: {
    ...
    section_why: "진짜 팬들의 후회",
    why: [
      { title: "그냥 울다 끝났어요", desc: "" },
      { title: "아무 말도 못 했어요", desc: "" },
      { title: "다시는 못 하는 후회예요", desc: "" },
    ],
    cta_bottom: "90초 준비 시작",
  ...
  id: {
    ...
    cta: "Mulai 90 Detikmu",
    free_note: "Gratis · 3x sehari · Tanpa akun",
    section_scenario: "Apa yang ingin kamu latih",
    section_why: "Cerita nyata para fans",
    why: [
      { title: "Aku cuma nangis sepanjang waktu", desc: "" },
      { title: "Aku nggak bisa ngomong apa-apa", desc: "" },
      { title: "Penyesalan yang nggak bisa diulang", desc: "" },
    ],
    cta_bottom: "Mulai 90 Detikmu",
  ...
  pt: {
    ...
    cta: "Começar Seus 90 Segundos",
    free_note: "Grátis · 3x por dia · Sem conta",
    section_scenario: "O que você quer praticar",
    section_why: "Histórias reais de fãs",
    why: [
      { title: "Eu só chorei o tempo todo", desc: "" },
      { title: "Não consegui dizer nada", desc: "" },
      { title: "Um arrependimento sem volta", desc: "" },
    ],
    cta_bottom: "Começar Seus 90 Segundos",
  ...
  fr: {
    ...
    cta: "Commencer Vos 90 Secondes",
    free_note: "Gratuit · 3x par jour · Sans compte",
    section_scenario: "Que voulez-vous pratiquer",
    section_why: "Vraies histoires de fans",
    why: [
      { title: "J'ai juste pleuré tout le temps", desc: "" },
      { title: "Je n'ai pas pu dire un mot", desc: "" },
      { title: "Un regret qu'on ne peut pas effacer", desc: "" },
    ],
    cta_bottom: "Commencer Vos 90 Secondes",
